...
// ========================= MediaBoxesd ===============================
  ...
  $.fn.mediaBoxes = function( options ) {
    ...
    var davidBlanco = function($this){
        ...
        var $navNext        = $('<div class="mediaBoxes-next" />').appendTo($lightbox);
        var $iconNext       = $('<i class="iconNext" />').appendTo($navNext);

        var $navPrev        = $('<div class="mediaBoxes-prev" />').appendTo($lightbox);
  ...
  $.fn.mediaBoxes.defaults = {
      ...
      loadMoreWord: "Carregar mais..", //The "Load More Entries" word so you can translate it to another lenguaje
